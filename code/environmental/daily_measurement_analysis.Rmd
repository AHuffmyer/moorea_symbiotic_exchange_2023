...
```{r}
daily<-read_xlsx("data/environmental/daily_measurements.xlsx")
...
EDIT BELOW THIS POINT WHEN WE HAVE DATA 
...
daily_treatment_summary<-daily_calc.long %>%
  ...
  geom_point()+
  geom_boxplot()+
  scale_colour_manual(name="", values=c("orange", "brown4", "gray"))+
  xlab("Date")+
  ylab("Value")+
  facet_wrap(~ metric, scales = "free")+
  theme_classic(); daily_treatment_summary

ggsave(filename="figures/environmental/summary_daily_measurements.png", plot=daily_treatment_summary, dpi=300, width=9, height=6, units="in")
```

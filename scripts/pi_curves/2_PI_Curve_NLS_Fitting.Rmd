...
ggsave("figures/pi_curves/PI_parameters.jpeg", PI.params, dpi=300, w=8, h=8, units="in") 
``` 
...
md <- read_csv("data/pi_curves/pi_curves_coral_metadata.csv") 
df <- left_join(pars, md) 
...
df$id_group <- paste0(df$sample_id,"_", df$Temp.Cat) 
...
ggsave("output/pi_curves/Pmax_outliersbygroup.pdf", outlier.plot, dpi=300, w=16, h=8, units="in") 

...
ggsave("figures/pi_curve_raw_plots_bycoral.pdf",raw.plot,  width = 10, height=6)
...
ggplot(aes(x=Temp.Cat.x, y=-Rd, color=Species, group=Species, fill=Species))+ 
  geom_point()+
  #geom_line()+
  facet_wrap(~ Species)+
  theme(legend.position = "none")
...
ggplot(aes(x=Temp.Cat.x, y=Pmax, color=Species, group=Species, fill=Species))+ 
  geom_point()+
  #geom_line()+
  facet_wrap(~ Species)+
  theme(legend.position = "none")

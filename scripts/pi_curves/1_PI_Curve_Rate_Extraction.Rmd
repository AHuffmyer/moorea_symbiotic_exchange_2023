...
## Import metadata
```{r, warning = FALSE}
path.p <- "data/pi_curves/runs/" #the location of all your respirometry files 
...
run.info <- read_csv(file = "data/pi_curves/pi_curves_run_metadata.csv")
...
metadata <- metadata %>%
  select(Species, sample_id, Run, Temp.Cat, Chamber.Vol.L, Date, Start.time, Stop.time, Light_Value, Light_Level)
```

...
- Glucose, F6P, pyruvate, a-ketoglutarate, ADP, concentration and labeling 
- NAD+, NADH, NADP+, NADPH concentration and labeling
- Glutamine and glutamate concentration and labeling 
- Arginine-glutamine concentration and labeling 
...
plot1<-carbon%>%
  ...
  facet_wrap(~species*Compound, scales="free")+

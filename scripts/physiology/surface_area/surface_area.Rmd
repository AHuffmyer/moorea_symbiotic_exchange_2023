...
#load wax data
wax.data <- read.csv("data/physiology/surface_area/surface_area_data.csv", header=TRUE)
...
# we need to add one smaller in the curve

#Save the output for use in normalization for phys assays
smpls%>%
  select(sample_id, surface.area.cm2, species, lifestage)%>%

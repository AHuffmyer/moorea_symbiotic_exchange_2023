...
plate <- as.numeric(str_sub(file.names, 25, 26)) #EDIT THIS AS NEEDED 

date <- str_sub(file.names, 4, str_length(file.names)-28) #grab date from file name EDIT IF NEEDED

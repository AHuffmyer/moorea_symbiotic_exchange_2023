...
sample.info <- read_csv(file = "data/p_r_rates/pi_curves_sample_metadata.csv")

# Load PI curve run metadata (i.e., light levels and interval times for each run)
run.info <- read_csv(file = "data/p_r_rates/pi_curves_run_metadata.csv")
...
write.csv(pr, "output/p_r_rates/pr_extracted_rates_Raw.csv")
```
...
write.csv(pr.out, "output/p_r_rates/pr_extracted_rates.csv")
```
